                ...
                <table id="Tabletotal" runat="server">
                    <tr>
                        <td style="width: 225px">
                            <strong><span style="font-size: 0.75em; font-family: Verdana">TOTAL AMOUNT RECEIVED</span></strong></td>
                        <td style="width: 100px">
                            <asp:Label ID="lblTotal" runat="server" Width="221px" Font-Names="Verdana" Font-Size="0.75em">R</asp:Label></td>
                    </tr>
                </table>
                <br />
                <br />
